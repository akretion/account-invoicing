...
class AccountFiscalPosition(models.Model):
    ...
    use_fiscal_position_option = fields.Boolean(
        string='Use fiscal position option')
            ...
            for tax in fposition_id.tax_ids:
                if fposition_id.use_fiscal_position_option:
                    if tax.tax_src_id.id == t.id \
                            and tax.fiscal_position_option_id.id == context['fiscal_position_option_id']:
                        if tax.tax_dest_id:
    ...
    def map_tax(self, taxes):
        ...
        for tax in taxes:
            ...
            for t in self.tax_ids:
                if self.use_fiscal_position_option:
                    if t.tax_src_id == tax \
                            and t.fiscal_position_option_id.id == self._context['fiscal_position_option_id']:
                        tax_count += 1
                        if t.tax_dest_id:
        ...
        for pos in fposition_id.account_ids:
            if fposition_id.use_fiscal_position_option:
                if pos.account_src_id.id == account_id \
                        and pos.fiscal_position_option_id.id == context['fiscal_position_option_id']:
        ...
        for pos in self.account_ids:
            if self.use_fiscal_position_option:
                if pos.account_src_id == account \
                        and pos.fiscal_position_option_id.id == self._context['fiscal_position_option_id']:
...
class AccountFiscalPositionTax(models.Model):
    ...
    fiscal_position_option_id = fields.Many2one(
        comodel_name="account.fiscal.position.option",
